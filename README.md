...
These are custom scripts or tools that I coded during penetration testing labs, capture the flag (CTF), [VulnHUB](https://www.vulnhub.com/), and [Hack the Box](https://www.hackthebox.eu/) exercises. 
...
* [*Vulnerabilities/MySQL/UDF.md*](https://github.com/weaknetlabs/Penetration-Testing-Grimoire/tree/master/Vulnerabilities/MySQL/UDF.md) - MySQL UDF Exploit from user to root.
#### Tools
